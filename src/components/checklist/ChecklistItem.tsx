...
export default function ChecklistItem({
  ...
  return (
    <div
      className={`flex flex-col gap-3.5 border-b border-border bg-white p-4 transition-colors duration-200 hover:bg-[#f0f9fa] sm:p-5 lg:flex-row lg:items-center lg:justify-between lg:gap-4 ${
        isLast ? "border-b-0" : ""
      }`}
    >
      {/* Item Details */}
      ...
      <div className="grid w-full grid-cols-3 gap-2 lg:flex lg:w-auto lg:items-center">
        ...
        <button
          ...
          className={`flex items-center justify-center gap-1.5 rounded-lg border px-3 py-2 text-xs font-semibold transition-colors duration-200 sm:py-1.5 ${
            status === "pass"
        ...
        <button
          ...
          className={`flex items-center justify-center gap-1 rounded-lg border px-3 py-2 text-xs font-semibold transition-colors duration-200 sm:py-1.5 ${
            status === "na"
      ...
      <div className="w-full lg:w-[320px]">
        {item.noteType === "alert" ? (
          <div className="flex h-9 items-center justify-between rounded-lg border border-amber-200 bg-amber-50 px-3 text-xs font-medium text-amber-800 transition-colors duration-200 hover:bg-amber-100">
          ...
          <div className="flex h-9 items-center gap-1.5 rounded-lg border border-amber-200 bg-amber-50/60 px-3 text-xs font-medium text-amber-700 transition-colors duration-200 hover:text-amber-800">
